...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen font-sans text-foreground">
      <div className="max-w-full mx-auto bg-white/50 backdrop-blur-sm shadow-xl shadow-gray-200/50 overflow-hidden min-h-screen flex flex-col border-b border-white/50">
